          ...
          <div class="m-4">
            ...
            <div class="row gy-3 mb-4">
                ...
                <div class="col-lg-2 col-sm-6 col-6 d-flex flex-row flex-lg-column flex-xl-row text-nowrap">
                  ...
                  <div class="">
                  <text class="h6">${{ number_format($d['item_subtotal'], 2) }}</text> <br />
                        <small class="text-muted text-nowrap"> ${{ number_format($d['item']->price, 2) }} / per pcs </small>
                  </div>
                </div>
        ...
        <div class="card shadow-0 border">
          <div class="card-body">
            <div class="d-flex justify-content-between">
              ...
              <p class="mb-2">${{ number_format($cart->CartTotal, 2) }}</p>
            </div>
            {{-- <div class="d-flex justify-content-between">
